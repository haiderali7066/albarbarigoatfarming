...
const SLIDES_DATA = [
  {
    image:
      "https://res.cloudinary.com/dvu9vmcqd/image/upload/v1785861846/1_nvvh85.jpg",
    subheading: "Welcome To Al-Barbari Goat Farming",
    titlePrimary: "Pakistan's Trusted",
    titleSecondary: "Goat Farm",
    description:
      "Delivering live goats directly to your doorstep in Lahore. We specialize in healthy Bakras for Aqeeqah and Sadqah.",
    features: [],
  },
  {
    image:
      "https://res.cloudinary.com/dvu9vmcqd/image/upload/v1785861849/3_ncvziy.jpg",
    subheading: "High Quality Breeds",
    titlePrimary: "Premium Meat",
    titleSecondary: "& Milk",
    description:
      "We provide premium goats suitable for both meat and milk production.",
    features: [
  ...
  {
    image:
      "https://res.cloudinary.com/dvu9vmcqd/image/upload/v1785861893/2_zcwvuh.jpg",
    subheading: "100% Certified Livestock",
    titlePrimary: "Safe & Healthy",
    titleSecondary: "Goats",
    description:
      "Only fully vaccinated and medically examined goats are available at our farm. Your trust is our priority.",
    features: [],
  },
];
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide((prev) =>
        prev === SLIDES_DATA.length - 1 ? 0 : prev + 1,
      );
    }, 5000);
        ...
        <div className="relative z-20 w-full max-w-[1920px] mx-auto px-5 md:px-12 lg:px-24">
          <div className="max-w-[800px] flex flex-col">
                    ...
                    {slide.features.length > 0 && (
                      <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-4 mt-2">
                        {slide.features.map((feature, idx) => (
                          <li
                            key={idx}
                            className="flex items-center text-white/95 text-sm md:text-[15px] font-medium"
                          >
            ...
            <div className="mt-8 md:mt-10 relative z-30">
              <a
                href="https://api.whatsapp.com/send/?phone=923280425087&text=I+need+Bakra.&type=phone_number&app_absent=0"
                target="_blank"
