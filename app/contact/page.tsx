  ...
  const faqs = [
    {
      ...
      answer:
        "Absolutely! We welcome customers to visit our farm to personally inspect and select their desired animals. Please contact us via WhatsApp to schedule your visit.",
    },
    {
      question: "Do you offer home delivery in Lahore?",
      answer:
        "Yes, we provide safe and secure home delivery across all areas of Lahore right to your doorstep.",
    },
    {
      question: "Can overseas Pakistanis order Sadqah/Qurbani?",
      answer:
        "Yes, we specialize in assisting overseas Pakistanis. We offer full video proof of the animal selection, Shariah-compliant slaughter, and meat distribution.",
    },
  ];
      ...
      <main className="bg-[#f8faf9] min-h-screen font-sans text-[#0a1a0f] overflow-hidden pt-[100px]">
        ...
        <section className="relative w-full min-h-[55vh] flex items-center justify-center pt-10 pb-32 overflow-hidden rounded-b-[40px] md:rounded-b-[80px] shadow-sm z-10">
          ...
          <div
            ...
            style={{
              backgroundImage: `url('https://images.unsplash.com/photo-1594903102373-c60317e08f23?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80')`,
            }}
          />
          ...
          <div className="absolute -left-20 top-20 opacity-5 select-none pointer-events-none z-0">
            <span className="text-[200px] font-serif font-bold text-white leading-none">
              البربری
            </span>
          </div>

          <div
            className={`relative z-10 text-center flex flex-col items-center px-6 max-w-3xl mx-auto mt-10 ${isVisible ? "animate-fade-in" : "opacity-0"}`}
          >
            ...
            <p className="text-gray-200 text-lg md:text-xl leading-relaxed font-medium max-w-2xl text-opacity-90">
              Reach out to Al Barbari Goat Farming for orders, Sadqah requests,
              or farm visits. Our team is available 24/7 to assist you.
            </p>
          </div>
        </section>
        ...
        <section className="max-w-[1440px] mx-auto px-6 relative z-20 -mt-24 mb-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card 1: WhatsApp */}
            <div
              className={`bg-white p-8 rounded-[30px] shadow-lg hover:shadow-[0_20px_40px_rgba(18,130,59,0.12)] border border-transparent hover:border-[#12823b]/20 transition-all duration-500 group relative overflow-hidden hover:-translate-y-2 ${isVisible ? "animate-fade-in delay-100" : "opacity-0"}`}
            >
              ...
              <div className="flex flex-col items-center text-center relative z-10">
                ...
                <h3 className="font-serif font-bold text-2xl mb-2 text-[#0a1a0f]">
                  WhatsApp Us
                </h3>
            ...
            {/* Card 2: Call */}
            <div
              className={`bg-[#12823b] p-8 rounded-[30px] shadow-lg hover:shadow-[0_20px_40px_rgba(18,130,59,0.2)] transition-all duration-500 group relative overflow-hidden hover:-translate-y-2 ${isVisible ? "animate-fade-in delay-200" : "opacity-0"}`}
            >
              ...
              <div className="flex flex-col items-center text-center relative z-10">
                ...
                <p className="font-bold text-[#ffc222] text-xl">
                  +92 327 7666764
                </p>
              </div>
            </div>
            ...
            {/* Card 3: Location */}
            <div
              className={`bg-white p-8 rounded-[30px] shadow-lg hover:shadow-[0_20px_40px_rgba(255,194,34,0.15)] border border-transparent hover:border-[#ffc222]/50 transition-all duration-500 group relative overflow-hidden hover:-translate-y-2 ${isVisible ? "animate-fade-in delay-300" : "opacity-0"}`}
            >
        ...
        <section
          className={`max-w-[1440px] mx-auto px-6 py-10 mb-20 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 ${isVisible ? "animate-fade-in delay-200" : "opacity-0"}`}
        >
          {/* === LEFT COLUMN: Form === */}
          <div className="lg:col-span-7 bg-white rounded-[40px] shadow-[0_20px_60px_rgba(0,0,0,0.06)] p-8 md:p-14 border border-gray-100 relative overflow-hidden">
            <h2 className="text-3xl md:text-4xl font-serif mb-4 text-[#0a1a0f]">
              Send a Message
            </h2>
            <p className="text-gray-500 mb-10 leading-relaxed">
              Fill out your details below and we will instantly connect with you
              on WhatsApp.
            </p>
            ...
            <form onSubmit={handleWhatsAppSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col group">
                  <label className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-2 ml-1 group-focus-within:text-[#12823b] transition-colors">
                    Full Name
                  </label>
                  <input
                    type="text"
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-10">
            ...
            <div className="bg-[#0a1a0f] text-white rounded-[40px] p-10 md:p-12 shadow-lg relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-300 mb-8 text-sm leading-relaxed opacity-90">
                  Prefer writing an email? Drop us a line and our support team
                ...
                <div className="flex items-center gap-4 bg-black/20 p-4 rounded-2xl backdrop-blur-sm border border-white/10 hover:border-[#ffc222]/50 transition-colors">
                  ...
                  <a
                    href="mailto:infoalbarbarigoatfarming@gmail.com"
                    className="font-bold hover:text-[#ffc222] transition-colors truncate"
                  >
                    Info@albarbarigoatfarming@gmail.com
                  </a>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-[40px] p-10 md:p-12 shadow-[0_20px_60px_rgba(0,0,0,0.06)] border border-gray-100 flex-grow flex flex-col justify-center">
              <h3 className="text-3xl font-serif mb-4 text-[#0a1a0f]">
                Connect With Us
              </h3>
              <p className="text-gray-500 mb-8 text-sm leading-relaxed">
                Follow us on social media to see our latest livestock, farm
                updates, and happy customers.
              </p>

              <div className="grid grid-cols-2 gap-4">
                <a
                  href="https://www.facebook.com/people/ALBarbari-Goat-Farming-Pakistan/61551449519975/"
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-3 p-4 rounded-2xl bg-[#f8faf9] border border-gray-100 hover:border-[#1877f2]/30 hover:bg-[#1877f2] hover:text-white transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1 group"
                >
                  <FaFacebookF className="text-[#1877f2] group-hover:text-white text-xl" />
                  <span className="font-bold text-sm">Facebook</span>
                </a>
                <a
                  href="https://www.instagram.com/albarbarigoat_lahore"
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-3 p-4 rounded-2xl bg-[#f8faf9] border border-gray-100 hover:border-transparent hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] hover:text-white transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1 group"
                >
                  <FaInstagram className="text-[#c13584] group-hover:text-white text-xl" />
                  <span className="font-bold text-sm">Instagram</span>
                </a>
                <a
                  href="https://www.youtube.com/@albarbarigoatfarimg"
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-3 p-4 rounded-2xl bg-[#f8faf9] border border-gray-100 hover:border-[#ff0000]/30 hover:bg-[#ff0000] hover:text-white transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1 group"
                >
        ...
        {/* ================= FAQ SECTION ================= */}
        <section
          className={`max-w-4xl mx-auto px-6 py-10 mb-20 ${isVisible ? "animate-fade-in delay-300" : "opacity-0"}`}
        >
          <div className="text-center mb-12">
            <h2 className="text-sm font-bold text-[#12823b] uppercase tracking-[0.2em] mb-2">
              Got Questions?
            </h2>
            <h3 className="text-4xl md:text-5xl font-serif text-[#0a1a0f]">
              Frequently Asked
            </h3>
          </div>
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  <span
                    className={`font-bold text-lg transition-colors ${activeFaq === index ? "text-[#12823b]" : "text-[#0a1a0f] group-hover:text-[#12823b]"}`}
                  >
                    {faq.question}
                  </span>
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 transition-all duration-500 ${activeFaq === index ? "rotate-180 bg-[#ffc222] text-[#0a1a0f]" : "bg-[#f8faf9] text-gray-400 group-hover:bg-[#12823b]/10 group-hover:text-[#12823b]"}`}
                  >
                    <FaChevronDown />
                  </div>
                </button>
        ...
        {/* ================= MAP SECTION ================= */}
        <section
          className={`max-w-[1440px] mx-auto px-6 pb-32 ${isVisible ? "animate-fade-in delay-300" : "opacity-0"}`}
        >
